	...
	return (
		...
		>
			<div className="w-full md:w-1/3 text-left">
				...
				>
					Data Engineering | Data Quality | Data Governance | Information Architecture | Data Strategy | Business Intelligence | Data-Driven Culture | São Paulo | Brasil |
				</motion.p>
				<motion.div
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
				...
				>
					<a
						download="SidneyMarceloFranco_CV.pdf"
						href="/files/SidneyMarceloFranco_CV.pdf"
